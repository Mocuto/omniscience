(function() {
	...
	*/
	omni.Conscience = function(io, name) {
		...
		this.thoughtNamespace.on("connection", function(socket) {
			...
			socket.on("disconnect", function() {
				obj.thoughtHandler.removeSocket(id)

				obj.onClientDisconnected(id, socket)
			})
	 ...
	 * @public
	 * @memberof (server) omni.(server) Conscience#
	 * @desc Called when a client disconnects. This function is to be overriden.
	 * @param {Any} id - The unique identifier assigned to that client.
	 * @param {Socket} socket - The socket that handles communication with that client.
	 */
	omni.Conscience.prototype.onClientDisconnected = function(id, socket) {
		//This function is to be overwritten
	}
	 ...
	 */
	omni.Conscience.prototype.sendThought = function(data, name, receivers) {
	 ...
	 * @param {Function} options.get - The get function of that property.
	 				The "this" argument will be the omni.Property instance that is created.
	 				The first parameter will be the client token.
	 				The second parameter will be the new value.
	 * @param {Function} options.set - The set function of that property. 
	 				The "this" argument of the function will be the omni.Property instance that is created.
	 				The first parameter will be the token.
	...
	omni.Conscience.prototype.addProperty = function(object, name, options) {
		return this.stateHandler.addProperty(object, name, options);
	}
